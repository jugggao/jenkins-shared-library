...
//            }
            if (script.params['GIT_BRANCH']) {
                data['git']['branch'] = script.params['GIT_BRANCH']
            }
            if (script.params['SKYWALKING']) {
                data.skywalking['enabled'] = true
            }
            if (script.params['COMMIT_ID']) {
                data.git['commitId'] = script.params['COMMIT_ID']
            }
        }
        catch (e) {
